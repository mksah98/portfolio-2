      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">{info.name}</h1>
            <p className="text-lg sm:text-xl text-muted-foreground">{info.title}</p>
          </div>
          ...
          I'm a passionate Software Development Engineer with 4 years of experience building scalable web applications 
          using React, Next.js, and TypeScript. 
          I specialize in transforming ideas into seamless digital experiences that users love. I'm a quick learner and a team player.
          </p>
