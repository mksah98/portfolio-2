...
import { FaBootstrap, FaCss3, FaGitAlt, FaGithub, FaHtml5, FaJs, FaReact, FaFileCode } from "react-icons/fa";
...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "SCSS", icon: <BsFiletypeScss className="text-cyan-400" /> },
    ],
  },
  {
    title: "Databases",
  ...
  },
  {
    title: "Testing & Tools",
    skills: [
      { name: "Playwright", icon: <GoFileCode className="text-orange-600" /> },
      { name: "Jest", icon: <FaFileCode className="text-black dark:text-white" /> },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Cursor", icon: <HiCursorArrowRipple className="text-blue-500" /> },
